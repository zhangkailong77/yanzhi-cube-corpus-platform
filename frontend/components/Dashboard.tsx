               ...
               <div className="flex flex-col xl:flex-row items-start xl:items-end gap-6 pt-5 border-t border-slate-100">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4 w-full xl:w-auto flex-grow">
                     ...
                     <FilterDropdown
                        ...
                        icon={Layers}
                        options={[
                           { value: 'all', label: t('domainAll') },
                           { value: 'general', label: '通用文本' },
                           { value: 'terminology', label: '术语 (Terminology)' },
                           { value: 'qa', label: '问答 (QA)' },
                           { value: 'alignment', label: '对齐 (Alignment)' },
                           { value: 'process', label: '规程 (Process)' },
                           { value: 'case', label: '案例 (Case)' },
                           { value: 'struction', label: '指令 (Struction)' },
                        ]}
                     />
